        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex">
                    <b>Posts</b>
                    <a href="javascript:void(0)" wire:click="create_post" class="btn btn-primary btn-sm ml-auto">Create
                        Post</a>
                </div>
                        ...
                        <table class="table">
                            ...
                            @foreach($posts as $post)
                                <tr>
                                    ...
                                    <td>
                                        <a wire:click="edit_post({{$post->id}})" class="btn btn-primary btn-sm">Edit</a>
                                        <a wire:click="delete_post({{$post->id}})" class="btn btn-danger btn-sm"
